<template>
    <div class="relative">
        ...
        <button @click="showNotifications = !showNotifications" id="dropdownNotificationButton"
        ...
        <!-- Dropdown menu -->
        <div v-if="showNotifications" id="dropdownNotification"
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <div class="flex-shrink-0">
                        <img class="rounded-full w-11 h-11" src="/images/index_v2/Dp.png" alt="Jese image">
                        <div
                ...
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <div class="flex-shrink-0">
                        <img class="rounded-full w-11 h-11" src="/images/index_v2/Dp.png"
                            alt="Joseph image">
                        <div
                ...
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <div class="w-full pl-3">
                        <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span
                            ...
                            in a comment: <span class="font-medium text-blue-500" href="#">@bonnie.green</span> what do you
                            say?</div>
