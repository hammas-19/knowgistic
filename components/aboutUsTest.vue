        ...
        <section class="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
            <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="max-w-3xl mx-auto text-center">
                    <p
                        class="inline-flex px-4 py-2 text-base text-gray-900 border border-gray-200 rounded-full font-pj">
                        Made by Developers, for Developers</p>
                    <h1
                    ...
                    <p class="max-w-md mx-auto mt-6 text-base leading-7 text-gray-600 font-inter">Lorem ipsum dolor sit
