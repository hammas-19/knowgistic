<template>
    <div class="flex flex-col items-center max-w-[340px] md:max-w-[280px]">
        <img :src="props.image"
            class="border rounded-xl rounded-b-none md:rounded-b-xl w-[340px] md:h-[200px] h-[120px] md:w-[420px] object-cover object-center"
            alt="">
        <div
