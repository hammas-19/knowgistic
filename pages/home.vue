<template>
    <div>
        ...
        <section class="bg-selago">
            ...
            <!-- Open Cards -->
            <div class="flex justify-evenly md:flex-row-reverse flex-col w-full  items-center gap-10 pb-14">
                <JobCourseCard v-for="items in 2" :class="{ 'flex-row-reverse': items === 2 }" />
            </div>
